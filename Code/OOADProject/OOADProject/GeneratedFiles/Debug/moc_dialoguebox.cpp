/****************************************************************************
** Meta object code from reading C++ file 'dialoguebox.h'
**
...
#error "The header file 'dialoguebox.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DialogueBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DialogueBox_t qt_meta_stringdata_DialogueBox = {
    {
QT_MOC_LITERAL(0, 0, 11) // "DialogueBox"
...
const QMetaObject DialogueBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DialogueBox.data,
      qt_meta_data_DialogueBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogueBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogueBox.stringdata0))
